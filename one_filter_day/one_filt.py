...
def gen_greedy_surveys(nside=32, nexp=1, exptime=30., filters=['r'],
                       camera_rot_limits=[-70., 70.],
    ...
    camera_rot_limits : list of float ([-70., 70.])
...
def generate_blobs(nside, nexp=1, exptime=30., filter1s=['r'],
                   filter2s=['r'], pair_time=22.,
                   camera_rot_limits=[-70., 70.], n_obs_template=3,
